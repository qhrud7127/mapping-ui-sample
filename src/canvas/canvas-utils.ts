import {Cardinality} from "../lib/domain/db-relationship.ts";
import {MIN_TABLE_SIZE, TableNodeType} from "./node/table-node.tsx";
import {DBTable} from "../lib/domain/db-table.ts";
import {addEdge, createGraph, Graph, removeEdge} from "../lib/graph.ts";
